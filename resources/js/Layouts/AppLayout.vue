                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <!-- generic -->
                                 <jet-nav-link :href="route('generics.index')" :active="route().current('generics.*')">
                                    Generics
                                </jet-nav-link>

                                <!-- brand -->
                                 <jet-nav-link :href="route('brands.index')" :active="route().current('brands.*')">
                                    Brands
                                </jet-nav-link>
                                ...
                                <!-- dosage form -->
                                 <jet-nav-link :href="route('dosage-forms.index')" :active="route().current('dosage-forms.*')">
                                    Dosage Forms
                                </jet-nav-link>
